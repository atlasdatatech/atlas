...
func (tileset *DB) GetTile(z uint8, x uint64, y uint64, data *[]byte) error {
...
func (tileset *DB) GetGrid(z uint8, x uint64, y uint64, data *[]byte) error {
...
func (tileset *DB) GetInfo() (map[string]interface{}, error) {
	var (
		key   string
		value string
	)
